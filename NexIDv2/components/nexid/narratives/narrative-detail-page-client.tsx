    ...
    <section id="detail" className="view active">
      ...
      <div className="detail-grid">
        ...
        <aside className="ticket">
          ...
          {orderType === "limit" ? <div className="amount"><span>¢</span><input value={Math.round(limitPrice * 100)} type="number" min={1} max={99} onChange={(event) => setLimitPrice(Math.max(1, Math.min(99, Number(event.target.value) || 1)) / 100)} /></div> : null}
