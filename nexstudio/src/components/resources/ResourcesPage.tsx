...
export function ResourcesPage() {
  ...
  const filtered = filter === "all" ? sources : sources.filter((source) => filter === "images" ? source.mimeType?.startsWith("image/") : filter === "web" ? source.kind === "WEBSITE" : filter === "text" ? source.kind === "TEXT" : source.kind === "FILE" && !source.mimeType?.startsWith("image/"));
