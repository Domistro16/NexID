...
export function MarketplacePage() {
  ...
  const [tab, setTab] = useState<Tab>(requestedTab === "my-work" || requestedTab === "services" || requestedTab === "direct" ? requestedTab : "discover");
