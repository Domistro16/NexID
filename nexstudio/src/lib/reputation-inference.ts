...
function normaliseReputationPayload(value: unknown, username: string) {
  ...
  return {
    ...
    analysis: {
      ...
      capabilities: Array.isArray(analysis.capabilities) ? analysis.capabilities : [],
      selectedWork: Array.isArray(analysis.selectedWork) ? analysis.selectedWork : [],
      activity: Array.isArray(analysis.activity) ? analysis.activity : [],
      network: Array.isArray(analysis.network) ? analysis.network : [],
      desiredWork: Array.isArray(analysis.desiredWork) ? analysis.desiredWork : [],
