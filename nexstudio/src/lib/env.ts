export const env = {
  ...
  nexmindApiUrl: process.env.NEXMIND_API_URL?.trim() || undefined,
  nexmindApiKey: process.env.NEXMIND_API_KEY?.trim() || undefined,
  nexmindModel: process.env.NEXMIND_MODEL?.trim() || "nexmind",
